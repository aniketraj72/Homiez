...
export default function Search() {
    ...
    const handleSubmit = (e) => {
        ...
        urlParams.set('type',sidebardata.parking);
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <select onChange={handleChange} defaultValue={'created_at_desc'} id="sort_order" className='border rounded-lg p-3'>
                        <option value='regulatPrice_desc'>Price high to low</option>
                        <option value='regularPrice_asc'>Price low to high</option>
                        <option value='createdAt_desc'>Latest</option>
                        <option value='createdAt_asc'>Oldest</option>
                    </select>
                </div>
                <button className='bg-slate-700 text-white p-3 rounded-lg uppercase op:95'>Search</button>
            </form>
        </div>
